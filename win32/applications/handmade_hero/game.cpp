...
#include "win32\libraries\math\constants.h"
#include "win32\libraries\math\integers.h"
#include "win32\libraries\math\bit_operations.h"
#include "win32\libraries\math\floats.h"
#include "win32\libraries\math\scalar_conversions.h"
#include "win32\libraries\math\transcendentals.h"
#include "win32\libraries\math\vector2.h"
#include "win32\libraries\math\vector3.h"
#include "win32\libraries\math\vector4.h"
#include "win32\libraries\math\rectangle2.h"
#include "win32\libraries\math\rectangle3.h"
...
extern "C" GAME_UPDATE_AND_RENDER(GameUpdateAndRender)
{
    ...
    if (!GameMemory->IsInitialized)
    {
        ...
        GameState->BackDropBitMap =
            LoadBitmap(GameMemory->PlatformReadFile, ThreadContext, (char *)"binary_data/handmade_hero/test/test_background.bmp");
        GameState->ShadowBitMap =
            LoadBitmap(GameMemory->PlatformReadFile, ThreadContext, (char *)"binary_data/handmade_hero/test/test_hero_shadow.bmp");
        GameState->TreeBitMap =
            LoadBitmap(GameMemory->PlatformReadFile, ThreadContext, (char *)"binary_data/handmade_hero/test2/tree00.bmp");
        GameState->StairWellBitMap =
            LoadBitmap(GameMemory->PlatformReadFile, ThreadContext, (char *)"binary_data/handmade_hero/test2/rock02.bmp");
        GameState->SwordBitMap =
            LoadBitmap(GameMemory->PlatformReadFile, ThreadContext, (char *)"binary_data/handmade_hero/test2/rock03.bmp");

        hero_bitmap_group *HeroBitmapGroup = &GameState->HeroBitmapGroups[0];
        HeroBitmapGroup->Head =
            LoadBitmap(GameMemory->PlatformReadFile, ThreadContext, (char *)"binary_data/handmade_hero/test/test_hero_right_head.bmp");
        HeroBitmapGroup->Cape =
            LoadBitmap(GameMemory->PlatformReadFile, ThreadContext, (char *)"binary_data/handmade_hero/test/test_hero_right_cape.bmp");
        HeroBitmapGroup->Torso =
            LoadBitmap(GameMemory->PlatformReadFile, ThreadContext, (char *)"binary_data/handmade_hero/test/test_hero_right_torso.bmp");
        HeroBitmapGroup->Alignment = V2(72, 182);

        HeroBitmapGroup = &GameState->HeroBitmapGroups[1];
        HeroBitmapGroup->Head =
            LoadBitmap(GameMemory->PlatformReadFile, ThreadContext, (char *)"binary_data/handmade_hero/test/test_hero_back_head.bmp");
        HeroBitmapGroup->Cape =
            LoadBitmap(GameMemory->PlatformReadFile, ThreadContext, (char *)"binary_data/handmade_hero/test/test_hero_back_cape.bmp");
        HeroBitmapGroup->Torso =
            LoadBitmap(GameMemory->PlatformReadFile, ThreadContext, (char *)"binary_data/handmade_hero/test/test_hero_back_torso.bmp");
        HeroBitmapGroup->Alignment = V2(72, 182);

        HeroBitmapGroup = &GameState->HeroBitmapGroups[2];
        HeroBitmapGroup->Head =
            LoadBitmap(GameMemory->PlatformReadFile, ThreadContext, (char *)"binary_data/handmade_hero/test/test_hero_left_head.bmp");
        HeroBitmapGroup->Cape =
            LoadBitmap(GameMemory->PlatformReadFile, ThreadContext, (char *)"binary_data/handmade_hero/test/test_hero_left_cape.bmp");
        HeroBitmapGroup->Torso =
            LoadBitmap(GameMemory->PlatformReadFile, ThreadContext, (char *)"binary_data/handmade_hero/test/test_hero_left_torso.bmp");
        HeroBitmapGroup->Alignment = V2(72, 182);

        HeroBitmapGroup = &GameState->HeroBitmapGroups[3];
        HeroBitmapGroup->Head =
            LoadBitmap(GameMemory->PlatformReadFile, ThreadContext, (char *)"binary_data/handmade_hero/test/test_hero_front_head.bmp");
        HeroBitmapGroup->Cape =
            LoadBitmap(GameMemory->PlatformReadFile, ThreadContext, (char *)"binary_data/handmade_hero/test/test_hero_front_cape.bmp");
        HeroBitmapGroup->Torso =
            LoadBitmap(GameMemory->PlatformReadFile, ThreadContext, (char *)"binary_data/handmade_hero/test/test_hero_front_torso.bmp");
        HeroBitmapGroup->Alignment = V2(72, 182);
