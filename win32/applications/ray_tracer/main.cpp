...
#include "win32\libraries\math\random.h"
...
#   include "win32\libraries\math\simd\1_wide\math.h"
#elif (SIMD_NUMBEROF_LANES == 4)
#   include "win32\libraries\math\simd\4_wide\math.h"
#elif (SIMD_NUMBEROF_LANES == 8)
#   include "win32\libraries\math\simd\8_wide\math.h"
#else
#   error "the defined SIMD_NUMBEROF_LANES is still not supported"
#endif // SIMD_NUMBEROF_LANES == 1

#include "win32\libraries\math\simd\shared\math.h"

#if (SIMD_NUMBEROF_LANES == 1)
#   include "win32\libraries\math\simd\1_wide\conversions.h"
#   include "win32\libraries\math\simd\1_wide\integers.h"
#   include "win32\libraries\math\simd\1_wide\floats.h"
#   include "win32\libraries\math\simd\1_wide\assertions.h"
#elif (SIMD_NUMBEROF_LANES == 4)
#   include "win32\libraries\math\simd\4_wide\conversions.h"
#   include "win32\libraries\math\simd\4_wide\integers.h"
#   include "win32\libraries\math\simd\4_wide\floats.h"
#   include "win32\libraries\math\simd\4_wide\assertions.h"
#   include "win32\libraries\math\simd\4_wide\vector3.h"
#elif (SIMD_NUMBEROF_LANES == 8)
#   include "win32\libraries\math\simd\8_wide\conversions.h"
#   include "win32\libraries\math\simd\8_wide\integers.h"
#   include "win32\libraries\math\simd\8_wide\floats.h"
#   include "win32\libraries\math\simd\8_wide\assertions.h"
#   include "win32\libraries\math\simd\8_wide\vector3.h"
#else
#   error "the defined SIMD_NUMBEROF_LANES is still not supported"
#endif // SIMD_NUMBEROF_LANES == 1

#include "win32\libraries\math\simd\shared\conversions.h"
#include "win32\libraries\math\simd\shared\integers.h"
#include "win32\libraries\math\simd\shared\floats.h"
#include "win32\libraries\math\simd\shared\vector3.h"
#include "win32\libraries\math\simd\shared\random.h"
