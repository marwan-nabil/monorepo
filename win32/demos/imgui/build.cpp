...
b32 BuildImguiDemo(build_context *BuildContext)
{
    ...
    AddCompilerSourceFile(BuildContext, "\\win32\\libraries\\imgui\\imgui*.cpp");
    AddCompilerSourceFile(BuildContext, "\\win32\\libraries\\shell\\dpi.cpp");
    AddCompilerSourceFile(BuildContext, "\\win32\\libraries\\system\\version.cpp");
