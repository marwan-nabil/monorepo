...
{
    AddSourceFile(BuildContext, "\\win32\\demos\\directx\\main.cpp");
    ...
    AddSourceFile(BuildContext, "\\win32\\demos\\directx\\vertex_shader.hlsl");
    AddCompilerFlags
    (
        BuildContext,
    ...
    AddSourceFile(BuildContext, "\\win32\\demos\\directx\\pixel_shader.hlsl");
    AddCompilerFlags
    (
        BuildContext,
