...
{
    AddSourceFile(BuildContext, "\\projects\\tests\\compilation_tests\\compilation_tests.cpp");

    AddCompilerFlags(BuildContext, "/nologo /I..\\.. /FC /O2 /Oi /GR- /EHa- /MTd /fp:fast /fp:except-");
