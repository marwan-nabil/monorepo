...
b32 BuildCompilationTestsMultiThreaded(build_context *BuildContext)
{
    AddSourceFile(BuildContext, "\\projects\\tools\\compilation_tests\\compilation_tests_multithreaded.cpp");
