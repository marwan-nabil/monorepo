...
#if (SIMD_NUMBEROF_LANES == 1)
#   include "libraries\win32\math\simd\1_wide\conversions.h"
#   include "libraries\win32\math\simd\1_wide\integers.h"
#   include "libraries\win32\math\simd\1_wide\floats.h"
#   include "libraries\win32\math\simd\1_wide\assertions.h"
#elif (SIMD_NUMBEROF_LANES == 4)
#   include "libraries\win32\math\simd\4_wide\conversions.h"
#   include "libraries\win32\math\simd\4_wide\integers.h"
#   include "libraries\win32\math\simd\4_wide\floats.h"
#   include "libraries\win32\math\simd\4_wide\assertions.h"
#   include "libraries\win32\math\simd\4_wide\vector3.h"
#elif (SIMD_NUMBEROF_LANES == 8)
#   include "libraries\win32\math\simd\8_wide\conversions.h"
#   include "libraries\win32\math\simd\8_wide\integers.h"
#   include "libraries\win32\math\simd\8_wide\floats.h"
#   include "libraries\win32\math\simd\8_wide\assertions.h"
#   include "libraries\win32\math\simd\8_wide\vector3.h"
#else
#   error "the defined SIMD_NUMBEROF_LANES is still not supported"
#endif // SIMD_NUMBEROF_LANES == 1

#include "libraries\win32\math\simd\shared\conversions.h"
#include "libraries\win32\math\simd\shared\integers.h"
#include "libraries\win32\math\simd\shared\floats.h"
#include "libraries\win32\math\simd\shared\vector3.h"
