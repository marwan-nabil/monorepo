...
#define MEMORY_LAYOUT_FILESYSTEM_DATA_FAR_ADDRESS ((void *)0x00500000) // segment:offset format
...
#define MEMORY_LAYOUT_FREE_MEMORY_FAR_ADDRESS ((void *)0x30000000) // segment:offset format
