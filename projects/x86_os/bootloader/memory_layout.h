...
#define MEMORY_LAYOUT_RAMDISK_LOAD_ADDRESS MEMORY_LAYOUT_FAT_DRIVER_DATA_FAR_ADDRESS
#define MEMORY_LAYOUT_FAT_DRIVER_TRANSIENT_MEMORY_START_ADDRESS MEMORY_LAYOUT_FREE_MEMORY_FAR_ADDRESS