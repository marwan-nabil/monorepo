...
{
    AddCompilerSourceFile(BuildContext, "\\projects\\demos\\directx\\main.cpp");
    ...
    AddCompilerSourceFile(BuildContext, "\\projects\\demos\\directx\\vertex_shader.hlsl");
    AddCompilerFlags
    (
        BuildContext,
    ...
    AddCompilerSourceFile(BuildContext, "\\projects\\demos\\directx\\pixel_shader.hlsl");
    AddCompilerFlags
    (
        BuildContext,
