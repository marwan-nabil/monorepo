...
AssertGoodMask(u32_lane Mask, u32 FaultIndex)
{
    if
    (
        ((U32FromU32Lane(Mask, 0) != 1) && (U32FromU32Lane(Mask, 0) != 0)) ||
        ((U32FromU32Lane(Mask, 1) != 1) && (U32FromU32Lane(Mask, 1) != 0)) ||
        ((U32FromU32Lane(Mask, 2) != 1) && (U32FromU32Lane(Mask, 2) != 0)) ||
        ((U32FromU32Lane(Mask, 3) != 1) && (U32FromU32Lane(Mask, 3) != 0))
    )
    {
