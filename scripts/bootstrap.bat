...
pushd tools\build
    cl^
        ...
        /I%root_path%^
        %root_path%\win32\tools\build\*.cpp^
        %root_path%\win32\tools\build\targets\*.cpp^
        %root_path%\win32\tools\build\targets\hdl\*.cpp^
        %root_path%\win32\tools\build\targets\win32\*.cpp^
        %root_path%\win32\tools\build\targets\i686-elf\*.cpp^
        %root_path%\win32\tools\build\actions\*.cpp^
        %root_path%\win32\libraries\shell\console.cpp^
        %root_path%\win32\libraries\file_system\*.cpp^
        ...
        %root_path%\win32\libraries\file_system\fat12\*.cpp^
        /Fe:build.exe^
