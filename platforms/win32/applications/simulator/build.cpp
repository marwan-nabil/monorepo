...
{
    AddCompilerSourceFile(BuildContext, "\\platforms\\win32\\applications\\simulator\\logic_gates.cpp");
    AddCompilerSourceFile(BuildContext, "\\platforms\\win32\\applications\\simulator\\main.cpp");
    AddCompilerSourceFile(BuildContext, "\\platforms\\win32\\applications\\simulator\\rendering.cpp");
    AddCompilerSourceFile(BuildContext, "\\platforms\\win32\\applications\\simulator\\simulation.cpp");
    AddCompilerSourceFile(BuildContext, "\\platforms\\win32\\libraries\\shell\\windows.cpp");
    AddCompilerSourceFile(BuildContext, "\\platforms\\win32\\libraries\\rasterizer\\rasterizer.cpp");
