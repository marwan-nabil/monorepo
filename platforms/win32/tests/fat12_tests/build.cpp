...
{
    AddCompilerSourceFile(BuildContext, "\\platforms\\win32\\tests\\fat12_tests\\test.cpp");
    ...
    AddCompilerSourceFile(BuildContext, "\\platforms\\win32\\libraries\\file_system\\fat12\\fat12*.cpp");
