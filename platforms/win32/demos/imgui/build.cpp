...
b32 BuildImguiDemo(build_context *BuildContext)
{
    ...
    AddCompilerSourceFile(BuildContext, "\\platforms\\win32\\libraries\\imgui\\imgui*.cpp");
    AddCompilerSourceFile(BuildContext, "\\platforms\\win32\\libraries\\shell\\dpi.cpp");
    AddCompilerSourceFile(BuildContext, "\\platforms\\win32\\libraries\\system\\version.cpp");
    AddCompilerSourceFile(BuildContext, "\\platforms\\win32\\demos\\imgui\\win32_backend.cpp");
    ...
    {
        AddCompilerSourceFile(BuildContext, "\\platforms\\win32\\demos\\imgui\\main_opengl2.cpp");
        AddCompilerSourceFile(BuildContext, "\\platforms\\win32\\demos\\imgui\\opengl2_backend.cpp");
    ...
    {
        AddCompilerSourceFile(BuildContext, "\\platforms\\win32\\demos\\imgui\\main_dx11.cpp");
        AddCompilerSourceFile(BuildContext, "\\platforms\\win32\\demos\\imgui\\dx11_backend.cpp");
