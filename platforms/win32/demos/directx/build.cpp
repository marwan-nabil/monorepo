...
{
    AddCompilerSourceFile(BuildContext, "\\platforms\\win32\\demos\\directx\\main.cpp");
    ...
    AddCompilerSourceFile(BuildContext, "\\platforms\\win32\\demos\\directx\\vertex_shader.hlsl");
    AddCompilerFlags
    (
        BuildContext,
    ...
    AddCompilerSourceFile(BuildContext, "\\platforms\\win32\\demos\\directx\\pixel_shader.hlsl");
    AddCompilerFlags
    (
        BuildContext,
