...
{
    AddCompilerSourceFile(BuildContext, "\\platforms\\win32\\demos\\refterm\\refterm.hlsl");
    ...
    StringCchCat(DestinationFileName, 1024, "\\platforms\\win32\\demos\\refterm\\");
...
b32 BuildRefTerm(build_context *BuildContext)
{
    ...
    {
        "\\platforms\\win32\\demos\\refterm\\refterm.c",
        "\\platforms\\win32\\demos\\refterm\\refterm_example_dwrite.cpp"
    };
    ...
    AddCompilerSourceFile(BuildContext, "\\platforms\\win32\\demos\\refterm\\splat.cpp");
    AddCompilerFlags(BuildContext, SharedCompilerFlags);
    AddCompilerFlags(BuildContext, "/O2");
    SetCompilerIncludePath(BuildContext, "\\");
    AddLinkerFlags(BuildContext, SharedLinkerFlags);
    ...
    AddCompilerSourceFile(BuildContext, "\\platforms\\win32\\demos\\refterm\\splat2.cpp");
    AddCompilerFlags(BuildContext, SharedCompilerFlags);
    AddCompilerFlags(BuildContext, "/O2");
    SetCompilerIncludePath(BuildContext, "\\");
    AddLinkerFlags(BuildContext, SharedLinkerFlags);
