static b32 BuildBootloaderImage(build_context *BuildContext)
{
    ...
    AddSourceFile(BuildContext, "\\x86_real\\os\\bootloader\\entry.s");
    ...
    AddSourceFile(BuildContext, "\\x86_real\\os\\bootloader\\main.c");
    ...
    AddSourceFile(BuildContext, "\\x86_real\\os\\bootloader\\linker.ls");
